![UNICORN Binance WebSocket API](https://github.com/oliver-zehentleitner/unicorn-binance-websocket-api/blob/master/images/logo/UNICORN_BINANCE_WEBSOCKET_API.svg)
