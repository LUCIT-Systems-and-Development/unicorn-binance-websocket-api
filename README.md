...
or with
```
binance_websocket_api_manager.create_stream(['trade', 'kline_1m'], ['btcusdt', 'bnbbtc', 'ethbtc'], output="UnicornFy")
```
...
## Live Demo
This live demo script is streaming from binance.com, hosted on a small VPS (2vCPU, 2GB RAM) at 
